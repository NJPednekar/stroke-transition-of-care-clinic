...
EPISODE_KEY_COLUMNS = ("patient_id", "discharge_date")
BARRIER_FIELDS = {
...
def load_data(source: str | Path | object) -> pd.DataFrame:
    ...
    if frame.duplicated(list(EPISODE_KEY_COLUMNS)).any():
        raise ValueError("Each patient_id + discharge_date episode must be unique.")
